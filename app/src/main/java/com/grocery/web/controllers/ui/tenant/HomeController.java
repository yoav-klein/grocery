...
public class HomeController {
    ...
    // create tenant
    @PostMapping("/tenants")
    public String createTenant(RedirectAttributes ra, @AuthenticationPrincipal SecurityUser user, @RequestParam("name") String tenantName) throws IOException {
        Tenant tenant = tenantService.createTenant(tenantName, user.getAppUser().getId());
